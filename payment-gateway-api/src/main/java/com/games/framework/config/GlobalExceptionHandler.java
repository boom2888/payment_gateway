...
//    public AjaxResult handleKYCException(KYCException e) {
...
//     * 处理SumSub相关异常
//     */
//    @ExceptionHandler(SumSubException.class)
//    public AjaxResult handleSumSubException(SumSubException e) {
//        log.error("SumSub error", e);
//        return AjaxResult.error(e.getMessage());
//    }
//
//    /**
...
//    public AjaxResult handleInvalidSignatureException(InvalidSignatureException e) {
