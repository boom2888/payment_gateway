...
//           int stock = brandService.getBrandStock(sysNotice.getNoticeTour());
//           int sold = brandService.getBrandSold(sysNotice.getNoticeTour());
//           sysNotice.setStock(stock);
//           sysNotice.setSold(sold);
        }
