<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="vipList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="VIP ID" align="center" prop="id" v-if="false"/>
    ...
    <el-col :span="12">
        <el-form-item label="VIP名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入VIP名称" />
        </el-form-item>
    </el-col>
...
<script>
import { listVip, getVip, delVip, addVip, updateVip, exportVip } from "@/api/payment/vip";
