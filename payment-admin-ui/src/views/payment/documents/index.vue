<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="类型编码" prop="documentTypeCode">
        <el-input
          v-model="queryParams.documentTypeCode"
          placeholder="请输入类型编码"
          clearable
          size="small"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['payment:documents:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['payment:documents:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['payment:documents:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['payment:documents:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="documentsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="文档ID" align="center" prop="id" v-if="false"/>
      <el-table-column label="公司ID" align="center" prop="businessCustomerCorporationId" />
      <el-table-column label="客户ID" align="center" prop="customerId" />
      <el-table-column label="文档URL" align="center" prop="documentUrl" />
      <el-table-column label="类型编码" align="center" prop="documentTypeCode" />
      ...
      <el-table-column label="其他文档描述" align="center" prop="otherDocumentDesc" />
      <el-table-column label="仅限企业类型股东" align="center" prop="businessMemberId" />
    ...
    <el-col :span="12">
        <el-form-item label="公司ID" prop="businessCustomerCorporationId">
          <el-input v-model="form.businessCustomerCorporationId" placeholder="请输入公司ID" />
        </el-form-item>
    </el-col>
    ...
    <el-col :span="12">
        <el-form-item label="类型编码" prop="documentTypeCode">
          <el-input v-model="form.documentTypeCode" placeholder="请输入类型编码" />
        </el-form-item>
    </el-col>
    ...
    <el-col :span="12">
        ...
        <el-col :span="24">
        <el-form-item label="其他文档描述" prop="otherDocumentDesc">
          <el-input v-model="form.otherDocumentDesc" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        </el-col>
    <el-col :span="12">
        <el-form-item label="仅限企业类型股东" prop="businessMemberId">
          <el-input v-model="form.businessMemberId" placeholder="请输入仅限企业类型股东" />
        </el-form-item>
    </el-col>
...
<script>
import { listDocuments, getDocuments, delDocuments, addDocuments, updateDocuments, exportDocuments } from "@/api/payment/documents";
  ...
  methods: {
    ...
    reset() {
      this.form = {
        ...
        remark: undefined,
        deleted: undefined,
        otherDocumentDesc: undefined,
        businessMemberId: undefined
      };
      this.resetForm("form");
    },
    /** 搜索按钮操作 */
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有文档数据项?', "警告", {
          ...
          return exportDocuments(queryParams);
        }).then(response => {
