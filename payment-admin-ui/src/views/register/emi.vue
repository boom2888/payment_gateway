<template>
  <div class="register-container">
    ...
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form" label-width="148px">
      <h3 class="title">{{ $t('common.emiMerchantRegister') }}</h3>
      ...
      <el-form-item :label="$t('common.email')" prop="email">
        <el-input v-model="registerForm.email" :placeholder="$t('common.pleaseEnterEmail')"/>
      </el-form-item>
  ...
  computed: {
    registerRules() {
      ...
      return {
        ...
        email: [
          {required: true, trigger: 'blur', message: this.$t('common.pleaseEnterEmail')},
          {type: 'email', trigger: 'blur', message: this.$t('common.pleaseEnterCorrectEmail')}
        ],
        password: [
