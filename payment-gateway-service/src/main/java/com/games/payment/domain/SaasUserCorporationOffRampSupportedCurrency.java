...
/**
 * 【请填写功能名称】对象 saas_user_corporation_off_ramp_supported_currency
 *
 * @author Ticker
 * @date 2025-07-06
 */
...
@TableName("saas_user_corporation_off_ramp_supported_currency")
public class SaasUserCorporationOffRampSupportedCurrency  {
...
private static final long serialVersionUID=1L;
    ...
    /** Currency Account ID in Checkout */
    @Excel(name = "Currency Account ID in Checkout")
