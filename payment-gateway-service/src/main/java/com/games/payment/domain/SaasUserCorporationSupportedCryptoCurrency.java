...
/**
 * 【请填写功能名称】对象 saas_user_corporation_supported_crypto_currency
 *
 * @author Ticker
 * @date 2025-07-06
 */
...
@TableName("saas_user_corporation_supported_crypto_currency")
public class SaasUserCorporationSupportedCryptoCurrency  {

private static final long serialVersionUID=1L;


    /** SaaS User Supported Crypto Currency ID */
    @TableId(value = "id")
    private Long id;
    ...
    /** Crypto Currency ID, default BitCoin */
    @Excel(name = "Crypto Currency ID, default BitCoin")
