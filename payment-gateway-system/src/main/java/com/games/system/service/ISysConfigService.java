...
public interface ISysConfigService
{
    ...
    //IP修正开关
    boolean ipSwitchOpen();
    //卡ID使用开关
    boolean isUserPaymentOptionOpen();
    /** 商户每日限额开关 **/
    boolean isShopLimitOpen();
    /** 获取Token最大复用次数 **/
    int getMaxTokenReuse();

    /** Mapping存储的最大值 **/
    int getMaxMappingCount();
	...
	boolean shift4SaleWithTokenIsOpen();

	int getShift4MaxMappingCount();
}
