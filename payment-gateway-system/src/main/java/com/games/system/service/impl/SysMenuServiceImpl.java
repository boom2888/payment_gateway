...
import com.games.system.domain.vo.MetaVo;
import com.games.system.domain.vo.RouterVo;
import com.games.system.mapper.SysMenuMapper;
...
import com.games.common.core.domain.TreeSelect;
...
public class SysMenuServiceImpl implements ISysMenuService
{
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus)
    {
        ...
        for (SysMenu menu : menus)
        {
            ...
            router.setMenuNameZh(menu.getMenuNameZh());
     ...
     */
    @Override
    public List<TreeSelect> buildMenuTreeSelect(List<SysMenu> menus, String language)
    {
        List<SysMenu> menuTrees = buildMenuTree(menus);
        return menuTrees.stream().map(m -> new TreeSelect(m, language)).collect(Collectors.toList());
    }
